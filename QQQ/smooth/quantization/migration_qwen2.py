...
import QQQ.smooth.models.quant_qwen2 as quant_qwen2
...
class MigratorBase(nn.Module):
    ...
    def qkv_function(self, input, weight):
        ...
        q, k = quant_qwen2.apply_rotary_pos_emb(
            q, k, cos, sin, self.extra_dict["position_ids"]
        )
        k = quant_qwen2.repeat_kv(k, self.extra_dict["num_key_value_groups"])
        v = quant_qwen2.repeat_kv(v, self.extra_dict["num_key_value_groups"])
